...
function y3(i2, t3) {
  l[i2] = t3.bind(null, l[i2] || function() {
  });
}
function _2(i2) {
  if (w2) w2();
...
Object.defineProperties(u.prototype, { constructor: { configurable: true, value: void 0 }, type: { configurable: true, value: g2 }, props: { configurable: true, get: function() {
  return { data: this };
...
y3("__b", function(i2, n2) {
  ...
  if ("string" == typeof n2.type) {
    var t3, r2 = n2.props;
    for (var o2 in r2) if ("children" !== o2) {
      var f2 = r2[o2];
      if (f2 instanceof u) {
        if (!t3) n2.__np = t3 = {};
        t3[o2] = f2;
...
y3("__r", function(i2, n2) {
  if ("function" == typeof n2.type && "undefined" != typeof window && window.__PREACT_SIGNALS_DEVTOOLS__) window.__PREACT_SIGNALS_DEVTOOLS__.enterComponent(n2);
  if (n2.type !== k) {
    _2();
    var t3, o2 = n2.__c;
    if (o2) {
      o2.__$f &= -2;
      if (void 0 === (t3 = o2.__$u)) o2.__$u = t3 = (function(i3) {
        var n3;
        E(function() {
          n3 = this;
        });
...
function b2(i2, n2, t3, r2) {
  var o2 = n2 in i2 && void 0 === i2.ownerSVGElement, f2 = d2(t3);
  return { o: function(i3, n3) {
    ...
    if (r2[n2] !== t4) {
      r2[n2] = t4;
      if (o2) i2[n2] = t4;
      else if (t4) i2.setAttribute(n2, t4);
...
var k2 = "undefined" == typeof requestAnimationFrame ? setTimeout : function(i2) {
  var n2 = function() {
    ...
    i2();
  }, t3 = setTimeout(n2, 35), r2 = requestAnimationFrame(n2);
};
var q = function(i2) {
...
function A2() {
  r(function() {
    var i2;
    while (i2 = l3.shift()) h2.call(i2);
  });
}
function T2() {
  if (1 === l3.push(this)) (l.requestAnimationFrame || k2)(A2);
}
function x2() {
  r(function() {
    var i2;
...
function F() {
  if (1 === m.push(this)) (l.requestAnimationFrame || q)(x2);
}
...
//# sourceMappingURL=signals.module-ECSUME72.js.map
